...
model=torch.load('MLP_bubble_T0_15_xi001/bubble_t0_15_40000.pt',map_location='cuda')
...
for epoch in range(20001):
    ...
    if np.mod(epoch,1000)==0:
        with torch.no_grad():
            ...
            plt.tight_layout()
            # plt.show()
            plt.savefig(f'MLP_bubble_T0_15_xi001/bubble_{epoch}.png', dpi=300)
            plt.close()
            torch.save(model.module, f'MLP_bubble_T0_15_xi001/bubble_t0_15_{epoch}.pt')
