...
t_start=1.5
t_end=3.0
model=torch.load('MLP_bubble_T0_15_xi0005/bubble_t0_15_40000.pt',map_location='cuda').to(device)
...
for epoch in range(40001):
    ...
    if np.mod(epoch,2000)==0:
        with torch.no_grad():
            ...
            plt.tight_layout()
            # plt.show()
            plt.savefig(f'MLP_bubble_T15_3_xi0005/bubble_{epoch}.png', dpi=300)
            plt.close()
            torch.save(model.module, f'MLP_bubble_T15_3_xi0005/bubble_t15_3_{epoch}.pt')
